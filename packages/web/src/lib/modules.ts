...
export const MODULES: ModuleMeta[] = [
  {
    ...
    description: 'Reservas, salon, comandas, cocina, caja y portal cliente QR en un mismo flujo.',
    badge: 'Food Service',
    icon: UtensilsCrossed,
    accent: '#ea580c',
    features: [
      'Reservas + estados de mesa',
      'Comandas con envio a cocina y caja',
      'KDS (Kitchen Display System) y tablero general de pedidos',
      'Propina sugerida configurable',
      'Portal cliente QR con llamados',
    ],
  },
  {
    id: 'MINIMARKET',
