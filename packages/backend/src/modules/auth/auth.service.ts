    ...
    const branch = await this.prisma.branch.create({
      data: {
        ...
        config: {
          ...
          kdsTheme: 'dark',
          kdsDefaultPrepMinutes: 15,
          kdsWarningMinutes: 20,
          kdsCriticalMinutes: 30,
          tipsEnabled: moduleType === ModuleType.RESTAURANT || moduleType === ModuleType.ALL,
      ...
      branch = await this.prisma.branch.create({
        data: {
          ...
          config: {
            ...
            kdsWarningMinutes: 20,
            kdsCriticalMinutes: 30,
            tipsEnabled: safeModule === ModuleType.RESTAURANT || safeModule === ModuleType.ALL,
            isDemo: true,
            moduleType: safeModule,
          },
        },
